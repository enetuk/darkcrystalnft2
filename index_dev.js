    ...
    .action(async (directory, cmd) => {
        ...
        for(var mod=0; mod<dark_metadata.modChances.length; mod++){
            ...
            if(count > 0){
                ...
                var mint_cmd = "./solana_integration/metaplex-program-library/target/build/metaplex-token-metadata-test-client mint_new_edition_from_master_edition_via_token --keypair " + keypair + " --url " + (0, various.getCluster)(env) + " --mint " + new_mint.mint.toBase58()
